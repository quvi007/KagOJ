...
function execute(command) {
  ...
  // echo 1234 | sudo -S  ./judger/libjudger.so --max_cpu_time=100 --max_real_time=1000 --max_memory=130023424 --exe_path=main --input_path=file/input/1.in --output_path=judger/output.out --error_path=judger/error.out